         ...
         <div className="container">
              ...
              <div className="sections">
                   <div className="left">
                        ...
                        <input type="text" name="title" placeholder="e.g. I will do something I'm really gooat at" onChange={handleChange} />
                        ...
                        <textarea name="desc" id="" cols="30" rows="16" onChange={handleChange} placeholder='Brief description to introduce your service to customers'></textarea>
